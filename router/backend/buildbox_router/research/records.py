"""Lane-private research records; public lane outputs remain the frozen contracts.

These records compose (never replace) ModelArtifact, Evidence and Fact. The rich
ledger stays separate until the integration owner versions the public schema.
"""
